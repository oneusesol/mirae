  ...
  return (
    <div className="container" style={{ display: "flex", flexDirection: "row", alignItems: "flex-start", justifyContent: "center", textAlign: "left", gap: "40px", width: "95%", margin: "0 auto" }}>
      <div style={{ flex: 1 }}>
        ...
        <br />
        <button className="check-btn" style={{ width: "100%", marginTop: "30px", height: "30px" }}>검사하기</button>
      </div>
      ...
      <div style={{ flex: 2 }}>
        ...
        <br />
        <button className="trend-btn" style={{ width: "100%", marginTop: "14px", height: "30px" }}>실시간 피싱 트렌드 보기</button>
      </div>
    </div>
  );
};
